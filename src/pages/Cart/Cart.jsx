          ...
          {checkoutMode ? (
            <div className="checkout_wrapper">
              <div className="checkout_step">
                <div
                  ...
                  style={{
                    background: checkoutStep === 1 ? "var(--primary)" : "#fff",
              ...
              <div className="checkout_step">
                <div
                  className="checkout_step_header"
                  style={{
                    background: checkoutStep === 2 ? "var(--primary)" : "#fff",
                    ...
                    <>
                      {user.savedAddresses.map((item) => (
                        <div
                          ...
                          style={{
                            background:
                              item === selectedAddress ? "#f5faff" : "#ffffff",
                          }}
                        >
                          <input
                            type="radio"
              ...
              <div className="checkout_step">
                <div
                  className="checkout_step_header"
                  style={{
                    background: checkoutStep === 3 ? "var(--primary)" : "#fff",
              ...
              <div className="checkout_step">
                <div
                  className="checkout_step_header"
                  style={{
                    background: checkoutStep === 4 ? "var(--primary)" : "#fff",
            ...
            <div className="cart_items_wrapper">
              <>
                {" "}
                <div
                  style={{ height: "calc(100% - 9rem)", overflowY: "scroll" }}
                >
                  {cartItems?.map((item, index) => (
                    <CartItem item={item} key={index} />
                  ))}
